...
Original file is located at
    https://colab.research.google.com/drive/1IoZVaRtUUDV8wwQIZaEjodyto6sYoUrk
"""
        ...
        try:
            ...
            if verificar_imagem_escura(cor_predominante):
                if saturacao < limiar_saturacao:
                    ...
                    imagem_binarizada = cv2.adaptiveThreshold(imagem_invertida, 255, cv2.ADAPTIVE_THRESH_MEAN_C, cv2.THRESH_BINARY, adaptive_block_size, adaptive_C)
